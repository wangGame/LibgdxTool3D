...
public class MahjGame extends Game {
    ...
    public void create() {
        ...
        tableEnvironment.set(new ColorAttribute(ColorAttribute.AmbientLight, 0.5f, 0.5f, 0.5f, 1f));//环境
        tableEnvironment.add(new PointLight().set(1.0f, 0.f, 0.f, 0.0f, 0.0f, 4.0f, 10.0f));
