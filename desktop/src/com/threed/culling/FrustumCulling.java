...
import com.threed.model.ModelLoad;


public class FrustumCulling extends ApplicationAdapter {
...
//        return true; // FIXME: Implement frustum culling
        ...
        return cam.frustum.pointInFrustum(vector3);
    }
    ...
    public static void main(String[] args) {
        ...
        new LwjglApplication(new FrustumCulling(), config);
    }
}
