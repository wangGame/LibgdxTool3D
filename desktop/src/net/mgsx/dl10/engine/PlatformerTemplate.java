...
public class PlatformerTemplate extends ScreenAdapter {
	public static final float cameraFollowSpeed = 13;
	...
	public PlatformerTemplate() {
		...
		engine.start();
		viewport = new FitViewport(GameSettings.WIDTH, GameSettings.HEIGHT);
		// HUD
		stage = new Stage(new FitViewport(GameSettings.WIDTH, GameSettings.HEIGHT));
